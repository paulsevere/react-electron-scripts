...
const electronCheck = require('./electronCheck');
...
module.exports = function(appPath, appName, verbose, originalDirectory, template) {
    ...
    const displayedCommand = useYarn
        ? "yarn"
        : "npm";
    ...
    console.log(chalk.yellow(`The main electron process is started in "main_process/index.js"`));

    console.log();
    console.log(chalk.cyan(`  ${displayedCommand} start`));
    console.log("    Starts the development server.  The main electron process directs the webview request the client scripts from the dev server.");
    console.log();
